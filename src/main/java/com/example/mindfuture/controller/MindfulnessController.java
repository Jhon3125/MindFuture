...
import com.example.mindfuture.repository.UsuarioSesionesDiariasRepository;
    ...
    public String showActivityPage(@PathVariable Integer id,
        ...
        try {
            ...
            String viewName = switch (actividad.getNombre().toLowerCase()) {
                ...
                // Luego se añadirán más actividades
            ...
            return "redirect:/midnfulness/mindfulness-game";
        }
    }
